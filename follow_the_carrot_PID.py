# -*- coding: utf-8 -*-
"""
Created on Thu Nov 26 15:46:36 2020
...
DEFININDO A POSIÇÃO E ORIENTAÇÃO DO ROBÔ.
...
class pid():
    ...
    def control(self,error):
        ...
        print('%.2f'%P,'%.2f'%I,'%.2f'%D,'%.2f'%(P+I+D))
        return P+I+D    
    
def send_path_4_drawing(path, sleep_time = 0.1):
...
if clientID!=-1:
    ...
    try:
        ...
        count = 0
        om_sp = 0
        d_controller   = pid(kp=0.3, ki=0.0, kd=0)
        omega_controller = pid(0.3, 0, 0.2)
